        ...
        <div className="flex-1 space-y-6">
          <div className="bg-sidebar rounded-2xl shadow-sm p-6 text-white relative overflow-hidden flex flex-col justify-between min-h-[350px]">
             ...
             <div className="space-y-2 mt-8 relative z-10 text-sm font-medium">
                <div className="flex justify-between items-center bg-white/10 p-3 rounded backdrop-blur-sm" style={{clipPath: 'polygon(0 0, 100% 0, 95% 100%, 5% 100%)'}}>
                  <span>Total<br/>Submissions</span>
                  <span className="text-lg">14,209</span>
                </div>
                <div className="flex justify-between items-center bg-white/10 p-3 rounded backdrop-blur-sm ml-4 mr-4" style={{clipPath: 'polygon(0 0, 100% 0, 92% 100%, 8% 100%)'}}>
                  <span>Validated<br/>Records</span>
                  <span className="text-lg">12,844</span>
                </div>
                <div className="flex justify-between items-center bg-white/10 p-3 rounded backdrop-blur-sm ml-8 mr-8" style={{clipPath: 'polygon(0 0, 100% 0, 88% 100%, 12% 100%)'}}>
