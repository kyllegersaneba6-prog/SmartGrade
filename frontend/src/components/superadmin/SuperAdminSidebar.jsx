...
import { LayoutDashboard, ShieldCheck, Users, Building2, X, User, LogOut } from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <div className="p-6 pb-8">
          ...
          <p className="text-xs text-gray-400 tracking-wider font-semibold uppercase">Super Admin Portal</p>
        </div>
