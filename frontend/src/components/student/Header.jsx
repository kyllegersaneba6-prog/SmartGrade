    ...
    <header className="h-20 bg-sidebar flex items-center justify-between px-8 text-white border-b border-sidebar-hover">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4 text-gray-300">
          ...
          <div className="w-9 h-9 rounded-full bg-gold-light border-2 border-gold overflow-hidden ml-2 flex items-center justify-center text-sidebar font-bold text-xs">
            SJ
          </div>
        </div>
      </div>
