...
const GlobalAnalytics = () => {
  ...
  staffUsers.forEach(u => {
    ...
    if (!deptMap[dept]) deptMap[dept] = { teachers: 0, admins: 0 };
  ...
  <div className="space-y-6 max-w-7xl mx-auto">
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
      ...
      <MetricCard 
        ...
        icon={ShieldCheck} 
        color="#3b82f6" 
        subtitle="Super Admins / Registrars"
      />
      <MetricCard 
        title="Audit logs" 
      ...
      <div className="flex flex-col gap-5">
        <div className="rounded-xl p-5 shadow-sm h-full" style={{ background: '#fff', border: '1px solid #e5e0d5' }}>
          ...
          <p className="text-[11px] mb-5 text-gray-500">
            Send an update or alert to Users (Teachers, Admins).
          </p>
