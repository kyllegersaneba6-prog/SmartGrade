          ...
          {dataLoading && components.length === 0 ? (
            ...
            <div className="text-center py-8 text-sidebar/40">
              ...
              <div className="relative inline-block">
                <button onClick={() => setAddCompOpen(true)} disabled={isReadOnly} className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-white rounded-lg shadow-sm hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed" style={{ background: '#f5a623' }}>
