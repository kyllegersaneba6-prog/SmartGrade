      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#e5e0d5]">
        ...
        {isArchiveMode && viewTerm && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 mb-6 flex items-center justify-between">
            ...
            <button
              onClick={() => { setViewTerm(null); navigate('/teacher/dashboard'); }}
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">You are currently working in this term.</p>
              </div>
            </div>
          </div>
        )}
              ...
              {allTerms.map(t => {
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      if (isActive) {
                        if (isArchiveMode) { setViewTerm(null); navigate('/teacher/dashboard'); }
                      } else {
                        setConfirmTerm(t);
                      }
                    }}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20">
          <div className="bg-white rounded-xl shadow-2xl p-6 max-w-md w-full mx-4 border border-gray-100">
            ...
            <p className="text-xs text-gray-500 mb-5">
              You will be redirected to this archived term. All pages will show data from this semester in <strong>read-only mode</strong>. You cannot add, edit, or delete any data while viewing a past term.
            </p>
